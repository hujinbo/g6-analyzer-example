...
import findRoute, {
  getUrlQuery,
} from '/Users/moyee/ant-repo/github/g6-analyzer-demo/node_modules/_umi-build-dev@1.13.11@umi-build-dev/lib/findRoute.js';
import moduleBeforeRenderer0 from '/Users/moyee/ant-repo/github/g6-analyzer-demo/src/pages/.umi/indexImport.js';
...
if (typeof document !== 'undefined') {
  const fetchUseForFetchHead = require('@alipay/bigfish/sdk/fetch');
  const a = document.createElement('a');
  fetchUseForFetchHead.interceptors.request.use((url, options) => {
    a.href = url;
